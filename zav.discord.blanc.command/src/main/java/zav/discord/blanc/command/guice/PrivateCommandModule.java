...
public class PrivateCommandModule extends AbstractModule {
  private final PrivateMessage msg;
  
  public PrivateCommandModule(PrivateMessage msg) {
    this.msg = msg;
  }
  ...
  protected void configure() {
    ...
    bind(PrivateChannel.class).toInstance(msg.getMessageChannel());
    bind(PrivateMessage.class).toInstance(msg);
