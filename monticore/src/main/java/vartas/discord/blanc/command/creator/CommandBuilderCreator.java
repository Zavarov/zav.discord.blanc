...
public class CommandBuilderCreator extends AbstractCreator<List<ASTCommandArtifact>, ASTCDCompilationUnit> implements CD4CodeInheritanceVisitor {
    private static final String CLASS_DIAGRAM = "vartas.discord.blanc.monticore.MontiCoreCommandBuilder";
    ...
    private static final String COMMAND_BUILDER = "vartas.discord.blanc.command.Command.CommandBuilder";
