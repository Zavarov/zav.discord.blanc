...
import zav.discord.blanc.parser.*;
 ...
 public  class MentionArgumentFactory   {
     public  static  MentionArgument create( Supplier<? extends MentionArgument> _factoryMentionArgument){

        MentionArgument _MentionArgumentInstance = _factoryMentionArgument.get();
        return _MentionArgumentInstance;
    }
