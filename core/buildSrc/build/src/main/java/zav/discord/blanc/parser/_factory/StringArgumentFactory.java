...
import zav.discord.blanc.parser.*;
 ...
 public  class StringArgumentFactory   {
     public  static  StringArgument create( Supplier<? extends StringArgument> _factoryStringArgument){

        StringArgument _StringArgumentInstance = _factoryStringArgument.get();
        return _StringArgumentInstance;
    }
