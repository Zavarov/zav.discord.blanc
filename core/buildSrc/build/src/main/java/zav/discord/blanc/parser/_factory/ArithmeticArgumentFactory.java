...
import zav.discord.blanc.parser.*;
 ...
 public  class ArithmeticArgumentFactory   {
     public  static  ArithmeticArgument create( Supplier<? extends ArithmeticArgument> _factoryArithmeticArgument){

        ArithmeticArgument _ArithmeticArgumentInstance = _factoryArithmeticArgument.get();
        return _ArithmeticArgumentInstance;
    }
