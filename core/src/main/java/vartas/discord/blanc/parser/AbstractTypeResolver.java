...
public abstract class AbstractTypeResolver extends AbstractTypeResolverTOP{
    ...
    public <T> List<T> resolveMany(@Nonnull List<? extends Argument> argument, @Nonnull Function<? super Argument, T> transformer) throws NoSuchElementException{
        return argument.stream().map(transformer).collect(Collectors.toList());
    }
