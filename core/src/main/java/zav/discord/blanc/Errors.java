...
public enum Errors {
    //File Access
    INVALID_JSON_FILE(0x1000, "The file ''{0}'' is not a valid JSON object."),
    INVALID_FILE(0x1001, "The file ''{0}'' couldn't be accessed."),
    ...
    public String toString(Object... params){
        String key = Long.toHexString(code);
        String value = MessageFormat.format(description, params);

        return MessageFormat.format("0x{0} {1}", key, value);
    }
