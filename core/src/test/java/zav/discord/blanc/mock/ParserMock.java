...
public class ParserMock implements Parser {
    public Map<Message, IntermediateCommand> commandMap = new HashMap<>();
    @Override
    public Optional<IntermediateCommand> parse(Message message) {
        return Optional.ofNullable(commandMap.getOrDefault(message, null));
    }
}
