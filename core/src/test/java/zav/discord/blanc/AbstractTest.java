...
public abstract class AbstractTest {
    ...
    public static void setUpAll() throws IOException {
        JSONCredentials.fromJson(JSONCredentials.CREDENTIALS, RESOURCES.resolve("credentials.json"));
    }
     ...
     */
    @BeforeEach
    public void setUpDiscord() throws IOException {
        shard = new ShardMock();
