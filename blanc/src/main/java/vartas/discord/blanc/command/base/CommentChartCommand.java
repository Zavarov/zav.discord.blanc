...
import vartas.reddit.chart.line.CommentChart;
...
/**
 * This command posts a plot containing the top comments in the given timeframe.
 */
public class CommentChartCommand extends CommenterChartCommandTOP {
    public CommentChartCommand(Message source, CommunicatorInterface communicator, List<ASTEntityType> parameters) throws IllegalArgumentException, IllegalStateException {
    ...
    public void run() {
        ...
        JFreeChart chart = new CommentChart().create(Multimaps.asMap(comments), interval);
