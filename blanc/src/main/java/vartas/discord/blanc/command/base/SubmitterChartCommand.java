...
import vartas.reddit.chart.line.SubmitterChart;
...
/**
 * This command posts a plot containing the unique submitter in the given timeframe.
 */
public class SubmitterChartCommand extends SubmitterChartCommandTOP{
    public SubmitterChartCommand(Message source, CommunicatorInterface communicator, List<ASTEntityType> parameters) throws IllegalArgumentException, IllegalStateException {
    ...
    public void run(){
        ...
        JFreeChart chart = new SubmitterChart().create(Multimaps.asMap(submissions), interval);
