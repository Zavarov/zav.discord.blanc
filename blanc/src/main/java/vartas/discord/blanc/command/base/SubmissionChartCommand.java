...
/**
 * This command posts a plot containing the unique submissions in the given timeframe.
 */
public class SubmissionChartCommand extends SubmissionChartCommandTOP{
    public SubmissionChartCommand(Message source, CommunicatorInterface communicator, List<ASTEntityType> parameters) throws IllegalArgumentException, IllegalStateException {
    ...
    public void run(){
        ...
        JFreeChart chart = new SubmissionChart().create(Multimaps.asMap(submissions), interval);
