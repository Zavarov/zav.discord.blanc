...
import vartas.reddit.chart.line.SpoilerChart;
...
/**
 * This command posts a plot containing the submissions that have been marked as Spoiler in the given timeframe.
 */
public class SpoilerChartCommand extends SpoilerChartCommandTOP{
    public SpoilerChartCommand(Message source, CommunicatorInterface communicator, List<ASTEntityType> parameters) throws IllegalArgumentException, IllegalStateException {
    ...
    public void run(){
        ...
        JFreeChart chart = new SpoilerChart().create(Multimaps.asMap(submissions), interval);
