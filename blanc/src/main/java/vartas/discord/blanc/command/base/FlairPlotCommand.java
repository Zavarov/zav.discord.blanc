...
import vartas.reddit.chart.pie.FlairPlot;
...
/**
 * Submits a pie chart over all of the submission flairs in the given time frame.
 */
public class FlairPlotCommand extends FlairPlotCommandTOP{
    public FlairPlotCommand(Message source, CommunicatorInterface communicator, List<ASTEntityType> parameters) throws IllegalArgumentException, IllegalStateException {
    ...
    public void run() {
        ...
        JFreeChart chart = new FlairPlot(.66).apply(submissions);
