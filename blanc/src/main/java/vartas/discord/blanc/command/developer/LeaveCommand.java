...
/**
 * This command instructs the bot to leave the specified guilds.
 */
public class LeaveCommand extends LeaveCommandTOP{
    public LeaveCommand(Message source, CommunicatorInterface communicator, List<ASTEntityType> parameters) throws IllegalArgumentException, IllegalStateException {
