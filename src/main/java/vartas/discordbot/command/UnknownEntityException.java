...
/**
 * This exception is thrown when the search for a Discord entity returned no result.
 * @author u/Zavarov
 */
public class UnknownEntityException extends RuntimeException{
    ...
    public <Q> UnknownEntityException(Q entity){
        super(String.format("An entity for the token %s wasn't found.",entity.toString()));
    }
}
