...
import vartas.discord.bot.command.parameter._ast.ASTTextChannel;
...
public class TextChannelParameterRequiresGuildCoCo implements CommandASTCommandCoCo, CommandVisitor {
    public static final String ERROR_MESSAGE = "This command must be restricted to a guild if it has a textchannel as a parameter.";
    ...
    @Override
    public void visit(ASTTextChannel node){
        if(!inGuild)
