...
public abstract class GuildDatabase {
   ...
   */
  public static int put(GuildDto guild) throws SQLException {
   ...
   */
  public static GuildDto get(long guildId) throws SQLException {
    ...
    return SqlQuery.unmarshal(guild, GuildDto.class);
  }
}
