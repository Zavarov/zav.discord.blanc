...
public abstract class AbstractEnvironment implements EnvironmentInterface {
     ...
     */
    @Override
    public Optional<List<SubmissionInterface>> pushshift(String subreddit, Instant start, Instant end) throws UnresolvableRequestException {
     ...
     */
    @Override
    public Optional<List<SubmissionInterface>> submission(String subreddit, Instant start, Instant end) throws UnresolvableRequestException {
